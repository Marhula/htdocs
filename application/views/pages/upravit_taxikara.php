...
<div class="form-group">
    <?php echo form_input(['name' => 'priezvisko', 'placeholder' => 'Priezvisko', 'class' => 'form-control','value'=>set_value('meno',$taxikari->priezvisko)]);
    echo form_error('priezvisko', '<span class="badge badge-danger">', '</span>'); ?>
</div>
<div class="form-group">
    <?php echo form_input(['name' => 'telCislo', 'placeholder' => 'Telefónne číslo', 'class' => 'form-control','value'=>set_value('meno',$taxikari->telCislo)]);
